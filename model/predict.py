...
def predict(
    ...
    console.print(
        f"Features: [dim]{len(feature_cols)}[/dim]"
    )

    if metrics:

        console.print(
            f"ROC-AUC: [green]{metrics.get('roc_auc',0):.4f}[/green]"
        )
    ...
    if dropped:
        ...
        console.print(
            f"[yellow]Dropped {dropped} rows with missing features.[/yellow]"
        )
    ...
    if DEBUG:
        ...
        console.print(
            f"Min : {df['bug_probability'].min():.6f}"
        )

        console.print(
            f"Max : {df['bug_probability'].max():.6f}"
        )
    ...
    if DEBUG:
        ...
        console.print(
            f"Minimum Probability : {df['bug_probability'].min():.6f}"
        )

        console.print(
            f"Maximum Probability : {df['bug_probability'].max():.6f}"
        )

        console.print(
            f"Mean Probability    : {df['bug_probability'].mean():.6f}"
        )

        console.print(
            f"Median Probability  : {df['bug_probability'].median():.6f}"
        )
